...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/accueil')) {
            ...
            if ($pathinfo === '/accueil/*') {
                return array (  '_controller' => 'KITJAMBONSiteBundle:Accueil:index',  '_route' => 'kitjambon_site_accueil2',);
            }
            ...
            if (rtrim($pathinfo, '/') === '/accueil/persentation') {
                ...
                return array (  '_controller' => 'KITJAMBONSiteBundle:Accueil:index',  '_route' => 'kitjambon_site_presentation',);
            }
