...
namespace Proxies\__CG__\KITJAMBON\CommentBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Comment extends \KITJAMBON\CommentBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'KITJAMBON\\CommentBundle\\Entity\\Comment' . "\0" . 'commentId', '' . "\0" . 'KITJAMBON\\CommentBundle\\Entity\\Comment' . "\0" . 'commentMessage', '' . "\0" . 'KITJAMBON\\CommentBundle\\Entity\\Comment' . "\0" . 'commentDate', '' . "\0" . 'KITJAMBON\\CommentBundle\\Entity\\Comment' . "\0" . 'fileId', '' . "\0" . 'KITJAMBON\\CommentBundle\\Entity\\Comment' . "\0" . 'membreId');
        }
    ...
    public function setCommentMessage($commentMessage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCommentMessage', array($commentMessage));

        return parent::setCommentMessage($commentMessage);
    }
    ...
    public function getCommentMessage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCommentMessage', array());

        return parent::getCommentMessage();
    }
