 ...
 */
class Option_Membre extends \KITJAMBON\MembreBundle\Entity\Option_Membre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'KITJAMBON\\MembreBundle\\Entity\\Option_Membre' . "\0" . 'optionId', '' . "\0" . 'KITJAMBON\\MembreBundle\\Entity\\Option_Membre' . "\0" . 'membreId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Option_Membre $proxy) {
